...
type AuthServiceClient interface {
	...
	VerifyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenClaims, error)
...
func (c *authServiceClient) VerifyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenClaims, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenClaims)
...
func (c *authServiceClient) RefreshToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*RefreshTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	VerifyToken(context.Context, *TokenRequest) (*TokenClaims, error)
...
func (UnimplementedAuthServiceServer) VerifyToken(context.Context, *TokenRequest) (*TokenClaims, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyToken not implemented")
}
func (UnimplementedAuthServiceServer) RefreshToken(context.Context, *TokenRequest) (*RefreshTokenResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/grpc/pb/authpb/auth.proto",
}
