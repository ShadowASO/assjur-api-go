...
type ContextoQueryModelType struct {
	Db *sql.DB
}

type ContextoQueryRow struct {
...
func NewContextoQueryModel(db *sql.DB) *ContextoQueryModelType {

	return &ContextoQueryModelType{Db: db}
}

// func (model *ContextoModelType) InsertRow(nrProc, juizo, classe, assunto string) (*ContextoRow, error) {
func (model *ContextoQueryModelType) InsertRow(paramsData BodyParamsContextoInsert) (*ContextoRow, error) {
...
func (model *ContextoQueryModelType) UpdateRow(paramsData BodyParamsContextoUpdate) (*ContextoRow, error) {
...
func (model *ContextoQueryModelType) UpdateTokens(idCtxt, promptTokens, completionTokens int) (*ContextoRow, error) {
...
func (model *ContextoQueryModelType) DeleteReg(idCtxt int) (*ContextoRow, error) {
...
func (model *ContextoQueryModelType) RowExists(nrProc string) (bool, error) {
...
func (model *ContextoQueryModelType) SelectContextoById(idCtxt int) (*ContextoRow, error) {
...
func (model *ContextoQueryModelType) SelectContextoByProcesso(nrProc string) ([]ContextoRow, error) {
	query := `SELECT * FROM contexto WHERE nr_proc=$1`
	rows, err := model.Db.Query(query, nrProc)
	if err != nil {
...
func (model *ContextoQueryModelType) SelectContextos() ([]ContextoRow, error) {
