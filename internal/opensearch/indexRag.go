...
type IndexRagType struct {
	osCli     *opensearchapi.Client
	indexName string
}

var RagServiceGlobal *IndexRagType
var onceInitRagService sync.Once

// Inicializa global
func InitRagService() {
	onceInitRagService.Do(func() {
		RagServiceGlobal = NewIndexRag()
		logger.Log.Info("Global RagService configurado com sucesso.")
	})
}

func NewIndexRag() *IndexRagType {
...
// Indexar documento
func (idx *IndexRagType) IndexaDocumento(params DocumentoRag) (*opensearchapi.IndexResp, error) {
...
// Atualizar documento
func (idx *IndexRagType) UpdateDocumento(id string, params RagText) (*opensearchapi.UpdateResp, error) {
	data, err := json.Marshal(BodyRagUpdate{Doc: params})
	if err != nil {
		return nil, err
	}
...
// Deletar documento
func (idx *IndexRagType) DeleteDocumento(id string) (*opensearchapi.DocumentDeleteResp, error) {
...
// Consulta por ID
func (idx *IndexRagType) ConsultaDocumentoById(id string) (*ResponseRag, error) {
	...
	var result struct {
		Source ResponseRag `json:"_source"`
	}
...
// Busca semântica
func (idx *IndexRagType) ConsultaSemantica(vector []float32, natureza string) ([]ResponseRag, error) {
	if idx.osCli == nil {
