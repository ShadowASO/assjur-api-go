...
## ⚖️ OBJETIVO GERAL
Você receberá uma peça processual (ex.: petição inicial, contestação, réplica, despacho, decisão etc.) e deverá extrair todas as 
informações relevantes **de forma literal e fiel ao conteúdo**, preenchendo um JSON de acordo com o tipo da peça processual.
...
8. **Seja bastante minuncioso ao descrever os fatos relatados na petição inicial, contestação e réplica**.
...
## 🧩 TABELA DE TIPOS DE PEÇA PROCESSUAL
```json
...
### a) Petição Inicial
{
  ...
  "fatos": "Descreva de forma minunciosa e completa os fatos descritos na inicial, com datas, valores, números de contrato e qualquer outro dado relevante.",
  "preliminares": [
